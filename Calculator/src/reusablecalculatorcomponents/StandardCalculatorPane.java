...
//		button0.setOnAction(calcEngine);
		button0.setOnAction(event -> calcEngine.handle(event));
		...
		buttonC.setOnAction(calcEngine);
		buttonBackspace.setOnAction(calcEngine);
		
		buttonSQRT.setOnAction(calcEngine);
		buttonMOD.setOnAction(calcEngine);
		buttonINV.setOnAction(calcEngine);
		buttonOPP.setOnAction(calcEngine);
