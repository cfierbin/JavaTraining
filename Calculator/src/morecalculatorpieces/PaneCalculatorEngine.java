...
public class PaneCalculatorEngine implements EventHandler<ActionEvent> {
 
 private SimpleCalculatorPane parent; // a reference to the Calculator
 ...
 PaneCalculatorEngine(SimpleCalculatorPane parent){
   this.parent = parent;
 }
